...
<head>
    ...
    <title>Daniel Merritt Online Resume</title>
...
<section class="section" id="about">
    ...
    <div class="section-heading">
        ...
        <div class="container" style= "text-align : center" >
            <p>Junior developer with six months of experience in
                <strong>fullstack web development </strong>
                with a degree in <strong> Computer Science </strong>
            and experience with multiple programming languages.
            Looking to gain more experience with new technologies, but
                open to work in any aspect of software development. </p>
        </div>
    </div>
                ...
                <div class="card-content">
                    ...
                    <div class="content">
                        <table class="table-profile">
                            ...
                            <tr>
                                <td>Email:</td>
                                <td>danielbmerrittiii@gmail.com</td>
                            </tr>
                        </table>
                    </div>
                    <br>
